package com.tornado4651.java_base.reflect;

import com.tornado4651.java_base.reflect.beans.Address;
import com.tornado4651.java_base.reflect.beans.Person;
import com.tornado4651.java_base.reflect.beans.Student;
...
public class StreamTest01_getClassName {
    ...
    public void getClassTest() {
        ...
        try {// 最常用的方法
            invocation1 = Class.forName("com.tornado4651.java_base.reflect.beans.Person");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void getInstanceTest() {
        try {
            Class<?> personInvocation = Class.forName("com.tornado4651.java_base.reflect.beans.Person");
    ...
    public void testGetInterfaces() throws ClassNotFoundException, InvocationTargetException, IllegalAccessException, InstantiationException {
        Class<?> studentClass = Class.forName("com.tornado4651.java_base.reflect.beans.Student");
    ...
    public void testGetSuperclass() throws ClassNotFoundException, InvocationTargetException, IllegalAccessException, InstantiationException {
        Class<?> dogsClass = Class.forName("com.tornado4651.java_base.reflect.beans.Dogs");
    ...
    public void tsetGetFilds() throws ClassNotFoundException {
        Class<?> invokeClass = Class.forName("com.tornado4651.java_base.reflect.beans.Person");
